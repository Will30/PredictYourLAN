...
{	
	...
	private boolean severalValue = false;
	...
	public void checkValue(String IPaddress,String updateOID)
	{
	    ...
	    new OctetString(sysContactValue);
	    ...
	    if (response != null)
	    {
		    ...
		    {
		    	System.out.println("ObjectIdentifier.checkValue() - No SNMP agent active or bad configuration");
		    }
	    }
	    else
	    {
	 ...
	 * @param IPaddress representing the strategic point IP address to be detected
	 * @version 1.00
	 */
...
/////////////************************    Getters and Setters *************************
	...
	public boolean isSeveralValue() {
		return severalValue;
	}


	public void setSeveralValue(boolean severalValue) {
		this.severalValue = severalValue;
	}
