 ...
 * @version 1.00
 * Class for mail using SMTP protocol and javax.mail library
 */
public class Mail 
{
	...
	private String smtpServer = "auth.smtp.1and1.fr"; // if sender is a gmail address, alternatively use personal smtp's server
	...
	{		
		System.out.println("Mail.Start()         -      Recipient "+this.recipient);
