...
//			json.put("id_Service",service.getID());
	...
	{
		Mail email = new Mail();
		String tempBody="Bonjour "+this.username+", \n \nL'accés vient d'être activé. \nPour rappel voici vos identifiants: \nVotre nom d'utilisateur : "+this.username+"\nVotre mot de passe: "+this.password+" \n \n Cordialement \n L'équipe PredictYourLAN";
		
		email.setUsername("xxx@.com");     // enter a sender address mail
		email.setPassword("your_password");				// enter a sender password
